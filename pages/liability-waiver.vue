			...
			<div class="pblock-8">
				<div class="container container--1400">
					<SplitContent gridGap="8rem" gridColumns="4fr 1fr" alignItems="center">
						<template #leftColumn>
							<h1 class="banner__header fs-xl regular clr-yellow mb-2">Liability Waiver</h1>
				...
				<div class="mblock-8">
					<SplitContent gridGap="8rem" gridColumns="1fr 500px ">
						<template #leftColumn>
							...
							<!-- <Button label="Download PDF Liability Waiver Form" buttonColor="purple" buttonBorderColor="purple" buttonColorHover="green" buttonBorderColorHover="green" /> -->
							<hr class="mblock-6" />
